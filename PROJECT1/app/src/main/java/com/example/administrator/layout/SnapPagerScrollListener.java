...
public class SnapPagerScrollListener extends RecyclerView.OnScrollListener {
    //Constants
    public static final int ON_SCROLL = 0; //스크롤이 될 때 콜백을 받고 싶다면
    public static final int ON_SETTLED = 1; // RecyclerView 의 State가 SCROLL_STATE_IDLE 일 때, 즉 페이지가 변경되고 완전히 멈출 대
